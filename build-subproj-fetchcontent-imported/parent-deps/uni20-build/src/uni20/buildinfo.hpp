...
inline constexpr std::array<Entry, 59> kBuildOptions{{
    ...
    {"UNI20_BACKEND_BLAS", "ON", "Enable the BLAS backend"},
    ...
    {"UNI20_FETCHCONTENT_BASE_DIR", "/home/runner/work/uni20/uni20/build-subproj-fetchcontent-imported/parent-deps/uni20-build/.cmake/third_party", "Resolved FetchContent base directory for build/stamp directories"},
    ...
    {"UNI20_FETCHCONTENT_SOURCE_BASE_DIR", "/home/runner/work/uni20/uni20/build-subproj-fetchcontent-imported/parent-deps/uni20-build/.cmake/third_party", "Resolved FetchContent source directory. With UNI20_FETCHCONTENT_SOURCE=OFF this matches UNI20_FETCHCONTENT_BASE_DIR"},
    ...
    {"UNI20_INTEGRATION_MODE", "fetchcontent", "subdirectory or fetchcontent"},
    ...
    {"UNI20_TEST_PARENT_BLAS", "imported", "No help, variable specified on the command line."},
...
inline constexpr std::array<Entry, 6> kDetectedEnvironment{{
    {"UNI20_DETECTED_BLAS_LIBRARIES", "", "Detected BLAS libraries"},
    {"UNI20_DETECTED_BLAS_VENDOR", "Generic", "Detected BLAS vendor"},
    {"UNI20_DETECTED_BLAS_VENDOR_MACRO", "UNI20_BLAS_VENDOR_GENERIC", "Vendor-specific macro for BLAS"},
