...
| `UNI20_ENABLE_MPLAPACK` | `OFF` | Enable the binary128 backend; prefer installed MPLAPACK 3.0.0 or newer and otherwise fetch `v3.0.0` |
...
[MPLAPACK Binary128 Setup](../linalg/mplapack_binary128.md) for the full package
